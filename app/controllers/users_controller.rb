 class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :password, :password_confirmation, :category, :kind, :summary)
    end
    ...
    def authorize
        if current_user.nil?
          ...
          if @user != current_user && current_user.kind != "Brand"
